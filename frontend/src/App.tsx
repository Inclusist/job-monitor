    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#how-it-works" className="text-slate-600 hover:text-cyan-600 transition-colors text-sm font-medium">How it Works</a>
          <a href="#quality" className="text-slate-600 hover:text-cyan-600 transition-colors text-sm font-medium">Philosophy</a>
          <a href="#cta" className="px-5 py-2.5 bg-cyan-600 text-white text-sm font-medium rounded-lg hover:bg-cyan-700 transition-colors">Login</a>
        </nav>
      </div>
    </motion.header>
  );
    ...
    <footer className="py-12 px-6 border-t border-cyan-100">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <p className="text-sm text-slate-600">
          © 2024 Inclusist. Built for clarity, not chaos.
        </p>
